...
const Navbar = () => {
    ...
    return (
        <header className="w-full fixed top-0 right-0 left-0">
            <nav className={`py-4 md:px12 px-4 bg-myColor ${isSticky ? "sticky top-0 right-0 left-0 bg-white" : ""}`}>
                {/* untuk device besar */}
                <div className="flex items-center justify-between">
                    ...
                    <div className="lg:flex items-center gap-3 hidden text-white text-lg">
                ...
                {/* menu semua devicess */}
                {
                    isMenuOpen && <div className="mt-4 p-4 bg-body rounded-lg text-white">
                        <Link href="home" className="block py-2 px-4 cursor-pointer text-primary hover:text-gray-400 ">Home</Link>
                        <Link href="skills" className="block py-2 px-4 cursor-pointer hover:text-gray-400 ">Skill</Link>
                        <Link href="about" className="block py-2 px-4 cursor-pointer hover:text-gray-400 ">About Me</Link>
                        <Link href="portfolio" className="block py-2 px-4 cursor-pointer hover:text-gray-400 ">Portfolio</Link>
                        <Link href="testimonials" className="block py-2 px-4 cursor-pointer hover:text-gray-400 ">Testimonials</Link>
                    </div>
                }
            </nav>
        </header>
